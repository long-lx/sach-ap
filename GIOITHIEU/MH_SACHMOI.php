...
<?php 
	...
	$sql = "SELECT Ms,Ten_sach,Don_gia,Hinh_minh_hoa FROM Sach LIMIT {$dongbatdau},{$kichthuoctrang}; ";
	$bang_sach = mysql_query($sql, $ketnoi);
...
<body>
	<div id="ProductTable">
		...
		<div class="phantrang">
			<a href="?trang=<?php echo $tranghientai-1; ?>"> &lt;&lt;</a>
			<?php for($i=1; $i<=$tongsotrang; $i++  ) { ?>
			<?php $css = ($i==$tranghientai) ? "class='tranghientai'" : "" ; ?>
			
			<a href="?trang=<?php echo $i; ?>"  <?php echo  $css;?> ><?php echo $i; ?></a>
